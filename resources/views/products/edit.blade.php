    ...
    @endif
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                name="harga" value="{{ $product->deskripsi}} ">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
            ...
            <div class="col-lg-6">
                ...
                <input type="nuber" class="form-control" id="harga" name="harga"
            ...
            <div class="col-lg-6">
                ...
                name="harga" value="{{ $product->discount }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
